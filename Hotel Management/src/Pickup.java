...
public class Pickup extends JFrame implements ActionListener {
	...
	Pickup()
	{
		...
		{
			Conn c = new Conn();
			ResultSet rs = c.s.executeQuery("select * from driver");//to get all values from room sql and store in result set
	...
	public void actionPerformed(ActionEvent ae)
	{
		if(ae.getSource() == submit)
		{
			try
			{
				String query = "select * from driver where brand = '"+typeofcar.getSelectedItem()+"' ";//to display all elements in room sql bed type with given data either single or double bed 
