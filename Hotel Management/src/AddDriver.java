...
public class AddDriver extends JFrame implements ActionListener{
	...
	AddDriver()
	{
		...
		gendercombo=new JComboBox(cleanOptions);//For drop down list
		...
		availablecombo=new JComboBox(driverOptions);//For drop down list
		...
		add.addActionListener(this);//******note "this"********
		add(add);
	...
	public void actionPerformed(ActionEvent ae)
	{
		if(ae.getSource() == add)
		{
			...
			String gender = (String) gendercombo.getSelectedItem();//getting selected element from drop box using "getSelectedItem()" and type casting that value to string to operate in sql
